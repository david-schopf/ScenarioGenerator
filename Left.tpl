Traffic SituationXYZ0%SNR%	
{
	  ...
	  */
	  Flowpoints = 
	  {
			...
			,(EI101, %2050%, 4, TrafficUserID, %SNR%3, TargetSpeed, 36.11)
			,(EI101, %2100%, 4, TrafficUserID, %SNR%3, TargetSpeed, 36.11)
			,(EI101, %2150%, 4, TrafficUserID, %SNR%3, TargetSpeed, 36.11)
